...
export default function Index(props) {
    ...
    return (
        <div className="flex w-full flex-col gap-y-6 pb-32">
                ...
                <div className="col-span-1">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Menyajikan ringkasan total Penghasilan selama satu tahun, lengkap dengan rincian
                                perbulan untuk setiap sumber penghasilan.
                            </CardDescription>
                        </CardHeader>
                ...
                <div className="col-span-1">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Menyediakan rekapitulasi bulanan seperti listrik, air, internet, dan lain-lain.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:px-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Menampilkan Laporan Setiap Kategori Perbulan</CardTitle>
                    <CardDescription>
                        ...
                        <Card>
                            ...
                            <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:px-6">
                                <Table>
                                    ...
                                    <TableFooter className="bg-gradient-to-br from-emerald-500 via-emerald-500 to-yellow-100 font-bold text-white">
                                        <TableRow>
                                            <TableCell>Total</TableCell>
...
Index.layout = (page) => <AppLayout children={page} title={page.props.pageSettings.title} />;
