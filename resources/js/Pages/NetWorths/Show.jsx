        ...
        <div className="flex w-full flex-col gap-y-6 pb-32">
            ...
            <Alert variant="info">
                ...
                <AlertDescription>
                    ...
                    dapat memberikan manfaat di masa depan. Contohnya: uang tunai, properti, inverstasi, piutang, atau
                    peralatan.
                </AlertDescription>
            </Alert>
                ...
                <Card key={index}>
                    ...
                    {netWorthAssets[netWorthAsset].length == 0 ? (
                        <EmptyState
                            ...
                            subtitle={`Mulailah dengan membuat aset (${netWorthAsset}) baru`}
                        />
                    ) : (
                        <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:px-6">
                            <Table className="w-full">
                                ...
                                <TableFooter className="bg-gradient-to-br from-emerald-500 via-emerald-400 to-yellow-100 font-bold text-white">
                                    <TableRow>
            ...
            {Object.keys(netWorthLiabilities).map((netWorthLiability, index) => (
                <Card key={index}>
                    <CardHeader>
                        ...
                        <CardDescription>{LIABILITYTYDESCRIPTION[netWorthLiability]}</CardDescription>
                    </CardHeader>
                    {netWorthLiabilities[netWorthLiability].length == 0 ? (
                        <EmptyState
                            icon={IconMenorah}
                            title={`Tidak ada kewajiban kekayaan bersih (${netWorthLiability})`}
                            subtitle={`Mulailah dengan membuat kewajiban (${netWorthLiability}) baru`}
                        />
                    ) : (
                        <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:px-6">
                            <Table className="w-full">
