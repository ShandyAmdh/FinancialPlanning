    ...
    return (
        <div className="flex w-full flex-col gap-y-6 pb-32">
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                ...
                {/* CICILAN HUTANG REPORT */}
                <div className="col-span-1">
                    <Card>
                        <CardHeader>
                            <CardTitle>Cicilan Hutang</CardTitle>
                            <CardDescription>
                                Mengelola dan memantau status pembayaran cicilan hutang termasuk jumlah yang telah di
                                bayar dan masih harus dilunasi.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:px-6">
                ...
                <div className="col-span-1">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Mencatat tagihan rutin seperti listrik, air, internet, dan lainnya, serta memberikan
                        ...
                        <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:px-6">
                            {budgetShoppings.length == 0 ? (
                                ...
                                <Table className="w-full">
                                    ...
                                    <TableBody>
                                        {budgetShoppings.map((budgetSaving, index) => (
                                            <TableRow key={index}>
                                                <TableCell>{budgetSaving.detail}</TableCell>
                                                <TableCell>{formatToRupiah(budgetSaving.plan)}</TableCell>
                                                <TableCell>{formatToRupiah(budgetSaving.actual)}</TableCell>
