...
Route::middleware('auth')->controller(GoalController::class)->group(function(){
...
Route::middleware('auth')->controller(BalanceController::class)->group(function(){
...
Route::middleware('auth')->controller(NetWorthController::class)->group(function(){
...
Route::post('net-worth/{netWorth}/assets/{asset}/net-worth-asset', NetWorthAssetController::class)
    ->name('net-worth-asset');

    Route::middleware('auth')->controller(LiabilityController::class)->group(function(){
...
Route::post('net-worth/{netWorth}/liabilities/{liability}/net-worth-liability', NetWorthLiabilityController::class)
    ->name('net-worth-liability');

Route::get('report-tracking', ReportTrackingController::class)->name('report-trackings');
